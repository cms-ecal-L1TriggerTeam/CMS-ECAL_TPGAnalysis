...
process.GlobalTag.toGet = cms.VPSet(
  cms.PSet(record = cms.string("EcalTPGStripStatusRcd"),
...
process.p = cms.Path(process.gtDigis*process.ecalDigis*process.ecalTriggerPrimitiveDigis*process.tpAnalyzer)
