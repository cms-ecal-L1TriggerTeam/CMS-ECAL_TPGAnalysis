...
if [ "X"${html_dir} == "X" ]
    ...
    html_dir='/afs/cern.ch/user/c/ccecal/scratch0/www/TPGAnalysis/Beam09'
    echo $html_dir
fi
...
if [ "X"${http_dir} == "X" ]
    then
    echo "using default html directory:"
    http_dir='http://test-ecal-cosmics.web.cern.ch/test-ecal-cosmics/TPGAnalysis/Beam09'
    echo $http_dir
fi
...
#html_dir='/afs/cern.ch/user/c/ccecal/scratch0/www/TPGAnalysis/CRAFT09'
#http_dir='http://test-ecal-cosmics.web.cern.ch/test-ecal-cosmics/TPGAnalysis/CRAFT09';
...
echo '.x '${work_dir}'/DrawTPGplots.C("histoTPG_'${run_num}${appendix}'.root",'${run_number_int}',kTRUE,"png","'${html_dir}/${run_num}${appendix}'",0)'
echo 'To make plots for ECAL triggers, run in ROOT:'
echo '.x '${work_dir}'/DrawTPGplots.C("histoTPG_Ecal_'${run_num}${appendix}'.root",'${run_number_int}',kTRUE,"png","'${html_dir}/${run_num}${appendix}'",1)'
echo
...
.x ${work_dir}/DrawTPGplots.C("histoTPG_${run_num}${appendix}.root",${run_number_int},kTRUE,"png","${html_dir}/${run_num}${appendix}",0)
.q
!

root -b <<!

.x ${work_dir}/DrawTPGplots.C("histoTPG_Ecal_${run_num}${appendix}.root",${run_number_int},kTRUE,"png","${html_dir}/${run_num}${appendix}",1)
.q
!
...
<br/><A href="#ECAL">BACK TO TOP (ECAL TRIGGER PLOTS)</A><BR>


<u><h3><A name="Timing1">Timing Occupancy</A><BR></h3></u>
...
<u><h3><A name="TP1">TP Occupancy</A><BR></h3></u>
...
<u><h3><A name="Emul1">TP Emulator Comparison</A><BR></h3></u>
<h5><FONT color="Black">For the comparison 2D plot:
<ol>
   <li>"green" = "good" (on-time and emulated E_T = data E_T)</li>
   <li>"yellow" = emulator 1 bunch crossing earlier than data</li>
...
<u><h3><A name="L1I1">Level 1 Trigger Comparisons (L1 Iso)</A><BR></h3></u>
<h5><FONT color="Black"> These plots concern Iso Candidates.</FONT></h5>
<h5><FONT color="Black">Calculation of the L1/TP ratio is in ADC counts: expected value is 0.5 (turquoise) (here TP=2*int(TP/2)).</FONT></h5>
<h5><FONT color="Black">RCT masked regions can be found in <A href="#Info">General Run Info</A><BR>.</FONT></h5>
...
<u><h3><A name="L1ITiming1">Level 1 Iso Timing</A><BR></h3></u>
<h5><FONT color="Black">These plots concern Iso Candidates.</FONT></h5>
<h5><FONT color="Black">Timing plot:
<ol>
   <li>negative value = pre-firing</li>
...
<u><h3><A name="L1N1">Level 1 Trigger Comparisons (L1 Non Iso)</A><BR></h3></u>
<h5><FONT color="Black"> These plots concern Non Iso Candidates.</FONT></h5>
<h5><FONT color="Black">Calculation of the L1/TP ratio is in ADC counts: expected value is 0.5 (turquoise) (here TP=2*int(TP/2)).</FONT></h5>
<h5><FONT color="Black">RCT masked regions can be found in <A href="#Info">General Run Info</A><BR>.</FONT></h5>
...
<u><h3><A name="L1NTiming1">Level 1 Non Iso Timing</A><BR></h3></u>
<h5><FONT color="Black">These plots concern Non Iso Candidates.</FONT></h5>
<h5><FONT color="Black">Timing plot:
<ol>
   <li>negative value = pre-firing</li>
...
<u><h3><A name="TTF1">TTF and FG</A><BR></h3></u>
<h5><FONT color="Black">TTF Mismatch: TTF code required all read-out, but not all towers were read out.</FONT></h5>
...
rm histoTPG_${run_num}${appendix}.root
rm histoTPG_Ecal_${run_num}${appendix}.root
